...
<script src="${siteurl}/js/ajaxupload.js"></script>
</head>
<body>
<div id="rrapp" v-cloak>
	<div v-show="showList">
		<div class="grid-btn">
		<@shiro.hasPermission name="sys:oss:all">
    ...
    <div v-show="!showList" class="panel panel-default">
		...
		<form class="form-horizontal">
			<div class="form-group">
				...
				<label class="radio-inline">
					<input type="radio" name="type" v-model="config.type" value="4"/> 本地储存
				</label>
			</div>
            ...
            <div v-show="config.type == 4">
                ...
                <div class="form-group">
                    <div class="col-sm-2 control-label">路径前缀</div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" v-model="config.localPrefix" placeholder="不设置默认为空"/>
                    </div>
                </div>
...
<script src="${siteurl}/js/oss/oss.js?_${.now?long?c}"></script>
</body>
</html>