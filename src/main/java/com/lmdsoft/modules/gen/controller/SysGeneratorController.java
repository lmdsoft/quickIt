...
import com.lmdsoft.modules.common.xss.XssHttpServletRequestWrapper;
...
public class SysGeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.reset();  
        response.setHeader("Content-Disposition", "attachment; filename=\"hxwdFrame.zip\"");
