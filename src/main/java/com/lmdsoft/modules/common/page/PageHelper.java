package com.lmdsoft.modules.common.page;
...
public class PageHelper implements Interceptor {
    private static final Logger logger = LoggerFactory.getLogger(PageHelper.class);//Logger logger = Logger.getLogger(PageHelper.class);
