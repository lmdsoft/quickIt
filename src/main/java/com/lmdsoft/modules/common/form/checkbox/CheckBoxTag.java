package com.lmdsoft.modules.common.form.checkbox;
...
//					Map<String,Map<String,Object>> allCodeMap= CodeCache.get(Constant.CODE_CACHE);
					Map<String,Map<String,Object>> allCodeMap= (Map<String, Map<String, Object>>) buildRedisUtils().get(Constant.CODE_CACHE);
					//获取mark=nameKey的字典
