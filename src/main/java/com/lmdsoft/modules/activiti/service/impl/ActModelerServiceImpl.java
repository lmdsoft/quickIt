...
import com.lmdsoft.modules.activiti.dao.ActExtendDao;
import com.lmdsoft.modules.activiti.dao.ExtendActModelDao;
import com.lmdsoft.modules.activiti.dto.ProcessNodeDto;
import com.lmdsoft.modules.activiti.dto.ProcessTaskDto;
import com.lmdsoft.modules.activiti.entity.*;
import com.lmdsoft.modules.activiti.service.*;
import com.lmdsoft.modules.activiti.utils.ActUtils;
import com.lmdsoft.modules.activiti.utils.AnnotationUtils;
import com.lmdsoft.modules.common.common.Constant;
import com.lmdsoft.modules.common.entity.TableInfo;
...
import com.lmdsoft.modules.common.utils.CodeUtils;
            ...
            if ("endEvent".equals(pvmActivity.getProperty("type"))) {
              ...
              //下一个节点不为结束节点
                ...
                if(Constant.ActAction.MULIT.getValue().equals(nextNode.getNodeAction())){
                    // TODO: 2018/8/10 暂不支持当前节点为会签，下一级节点也为会签
                    //设置会签人员集
                    ...
                    if(isOver){
                        ...
                        for (Task t:tasks){
                            //设置下一个任务的办理人
                            // TODO: 2018/8/10 如果是下个节点是并行结果，那么这里需要处理下 待开发
